...
type SampleBuilder struct {
	// minConsume how many packets need to arriv
	minConsume       uint16
...
//
// Insert does not copy the input. If you wish to reuse
...
// purged in time rather than building up an extraordinarily long delay.
